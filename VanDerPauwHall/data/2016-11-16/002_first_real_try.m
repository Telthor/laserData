...
Temperature = 260; %K Sample temperature
Bfield_Rsheet = 3000; %G
Bfield_Hall = 3000; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 26; % Number of points for the IV curve of the Hall measurement
IsourceMax = 50e-6; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
