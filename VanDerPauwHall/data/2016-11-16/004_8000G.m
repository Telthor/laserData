...
%% Settings
Exp_Comment = 'VdP_EDF6_SiBi';
Temperature = 275; %K Sample temperature
Bfield_Rsheet = 0; %G
Bfield_Hall = 8000; %G Magnetic field at which the Hall measurement will be caried out
...
t_wafer_cm = 0.0001; % wafer thickness in cm D0XDEV_bulkdoped: 0.0525;
