...
%% Settings
Exp_Comment = '1078, offRes, 125mW+ND2';
...
IsourceMax = 1.5e-8; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
...
Kmeas.ID = '2';
Kmeas.connect; end
if ~exist('Wavemeter'); Wavemeter = WS7Class; 
Wavemeter.ID = '3';
Wavemeter.connect; end
...
EX.wavelength = zeros(8,1); % Wavelength array for each measurement
...
% Measure wavelength
EX.wavelength(ct_meas) = Wavemeter.get_wavelength();
