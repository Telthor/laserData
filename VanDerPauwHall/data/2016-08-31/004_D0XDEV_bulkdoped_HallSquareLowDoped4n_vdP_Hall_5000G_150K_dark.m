...
%% Settings
Temperature = 150; %K Sample temperature
Bfield = 5000; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 21; % Number of points for the IV curve of the Hall measurement
IsourceMax = 3000e-6; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
Ksource_Vc = 0.2; % Source voltage compliance
Kmeas_Vrange = 0.1; % Measurement voltage range of voltmeter
