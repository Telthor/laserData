...
%% Settings
Temperature = 20; %K Sample temperature
Bfield = 3000; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 11; % Number of points for the IV curve of the Hall measurement
IsourceMax = 1e-9; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
Ksource_Vc = 1; % Source voltage compliance
Kmeas_Vrange = 1; % Measurement voltage range of voltmeter
