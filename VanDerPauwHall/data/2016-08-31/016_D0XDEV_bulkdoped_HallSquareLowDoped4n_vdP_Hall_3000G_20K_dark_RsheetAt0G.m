...
IsourceMax = 10e-7; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
Ksource_Vc = 0.5; % Source voltage compliance
Kmeas_Vrange = 0.5; % Measurement voltage range of voltmeter
