...
Bfield_Rsheet = 00; %G
Bfield_Hall = 00; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 21; % Number of points for the IV curve of the Hall measurement
IsourceMax = 6000e-9; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
