...
Bfield_Rsheet = 0; %G
Bfield_Hall = 0; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 26; % Number of points for the IV curve of the Hall measurement
IsourceMax = 100e-6; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
