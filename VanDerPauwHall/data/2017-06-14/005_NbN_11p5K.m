...
% worksheet linked therein. (Careful though: Carrier type definition wrong)
...
%    C2 | /      \ | C3
%       |/        \|
%       |          |     With positive magnetic field direction should be out of screen                                  
%       |\        /|     i.e Sample should be mounted such that the positive                                          
%    C1 |_\______/_| C4  B field  facing towards you when looking down at sample
%                           surface.
%
...
%% Settings
Exp_Comment = 'VdP_NbN_Chalmers_11p5K';
Temperature = 11.5; %K Sample temperature
Bfield_Rsheet = 0; %G
Bfield_Hall = 100; %G Magnetic field at which the Hall measurement will be caried out

Npoints = 26; % Number of points for the IV curve of the Hall measurement
IsourceMax = 0.1e-6; % Source current will be linspace(-IsourceMax, IsourceMax, Npoints)
Ksource_Vc = 4; % Source voltage compliance
Kmeas_Vrange = 4; % Measurement voltage range of voltmeter
NPLC=1; % Integration time. 
t_wafer_cm = 0.000005; % wafer thickness in cm D0XDEV_bulkdoped: 0.0525;

%% Preparations
% Add dependencies
root_path = 'C:\Users\Christoph\Documents\MATLAB\GARII\';
addpath([root_path '.']);
