...
Npoints = 11;
IsourceMax = 100e-6;
Ksource_Vc = 0.1; % source voltage compliance
Kmeas_Vrange = 0.1;
NPLC=1;
...
IsourceArrs = {'M1_I12', 'M2_I23', 'M3_I34', 'M4_I41',     'HallM1_I13p', 'HallM2_I42p', 'HallM3_I42n', 'HallM4_I13n' };
VmeasArrs2p = {'M1_V12', 'M2_V23', 'M3_V34', 'M4_V41',     'HallM1_V13p', 'HallM2_V42p', 'HallM3_V42n', 'HallM4_V13n' };
VmeasArrs4p = {'M1_V43', 'M2_V14', 'M3_V21', 'M4_V32',     'HallM1_V24p', 'HallM2_V13p', 'HallM3_V13n', 'HallM4_V24n' };
ResistanceArrs={'M1_R1243', 'M2_R2314', 'M3_R3421', 'M4_R4132', ...
    'HallM1_RH1324p', 'HallM2_RH4213p' 'HallM3_RH4213n', 'HallM4_RH1324n'};
EX.Bfields = {0, 0, 0, 0, Bfield, Bfield, -Bfield, -Bfield, };
EX.K2400Low = {    'C1', 'C2', 'C3', 'C4',    'C1', 'C4', 'C4', 'C1'};
EX.K2400High = {   'C2', 'C3', 'C4', 'C1',    'C3', 'C2', 'C2', 'C3' };
EX.K6430Low = {    'C4', 'C1', 'C2', 'C3',    'C2', 'C1', 'C1', 'C2'};
EX.K6430High = {   'C3', 'C4', 'C1', 'C2',    'C4', 'C3', 'C3', 'C4'};
...
while ~strcmpi(result, 'ok')
    ...
    msg = sprintf(msg, EX.Bfields{ct_meas}, EX.K2400Low{ct_meas}, EX.K2400High{ct_meas}, EX.K6430Low{ct_meas}, EX.K6430High{ct_meas} );
    result = input(msg, 's');
end
...
if ct_meas==8
    ...
    q=1.60217662e-19;
    EX.carrier_density_sheet_cm2 = (Bfield*1e-4)/q/EX.RH_average*1e-4;
    ...
    disp(sprintf('\n--> Wafer resistivity: %.2g Ohm,\n-->Carrier density: %.2g cm^-3,\n-->Carrier mobility: %.2g cm^2/V/s',...
        mean(EX.resistivity),EX.carrier_density,EX.carrier_mobility_cm2perVs));
end
